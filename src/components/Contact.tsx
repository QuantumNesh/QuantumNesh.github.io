  ...
  const contactInfo = [
    {
      icon: Mail,
      label: 'Email',
      value: 'nimesh.gamage@outlook.com',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto mt-8">
            Open to technical support, software, automation, and product-focused opportunities where practical problem solving matters.
          </p>
        </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="Tell me about the work, role, or project you have in mind..."
                  />
                </div>
                ...
                <button
                  type="submit"
                  disabled={sending}
                  className="relative w-full px-6 py-4 bg-gradient-to-r from-blue-600 to-cyan-600 text-white font-semibold rounded-xl transition-all duration-300 transform shadow-lg hover:shadow-blue-500/25 overflow-hidden group hover:from-blue-700 hover:to-cyan-700 hover:scale-[1.02] disabled:opacity-70 disabled:cursor-not-allowed"
                >
          ...
          <div className="space-y-8">
                ...
                {contactInfo.map((info, index) => (
                  ...
                  >
                    ...
                    <div className="ml-5">
                      ...
                      <p className="text-white group-hover:text-blue-400 transition-colors duration-300 font-medium mt-1 break-all">
                        {info.value}
                      </p>
                    </div>
                  </a>
            ...
            <div className="p-6 bg-gradient-to-r from-green-900/20 to-green-800/10 backdrop-blur-sm rounded-xl border border-green-900/20 flex items-center">
              ...
              <div>
                ...
                <p className="text-gray-300">Available for conversations around diagnostics, software, data tooling, and technical support roles.</p>
              </div>
            </div>
          </div>
        </div>
